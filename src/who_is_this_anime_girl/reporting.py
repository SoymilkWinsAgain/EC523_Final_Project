...
def save_training_artifacts(output_dir: str | Path, history: list[dict[str, Any]]) -> None:
    ...
    plot_metric_group(
        ...
        [
            ...
            "val/text_to_identity_recall@1",
            "val/text_to_identity_recall@5",
            "val/text_to_identity_recall@10",
            "val/text_to_identity_mrr",
            "val/image_to_image_recall@1",
            "val/image_to_image_recall@5",
            "val/image_to_image_recall@10",
            "val/image_to_image_mrr",
        ],
